...
const FilterPanel: React.FC = () => {
    ...
    return (
        <div className={'filter-panel' + ' ' + classMenu}>
            ...
            <div className={"filter-panel__wrapper"  + ' ' + classMenu}>
                <div className="filter-panel__checks">
                    <Dropdown className="mt-3 mb-3 filter-panel__checks_region">
                    ...
                    <Button variant='outline-warning' className="filter-panel__checks_btn">Показать</Button>
                </div>
